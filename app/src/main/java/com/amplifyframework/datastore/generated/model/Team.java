...
public final class Team implements Model {
  ...
  private final @ModelField(targetType="TaskGenerated") @HasMany(associatedWith = "team", type = TaskGenerated.class) List<TaskGenerated> tasks = null;
  ...
  public List<TaskGenerated> getTasks() {
      return tasks;
  }
